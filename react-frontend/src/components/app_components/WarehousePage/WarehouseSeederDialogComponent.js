...
import seederData from "./warehouse.seeder.json";
...
const WarehouseSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(WarehouseSeederDialogComponent);
