...
const SingleWarehousePage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("warehouse")
            .get(urlParams.singleWarehouseId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleWarehouseId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>warehouse/{urlParams.singleWarehouseId}</p> */}
            </div>
      ...
      <CommentsSection
        recordId={urlParams.singleWarehouseId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleWarehousePage);
