...
import SingleWarehousePage from "../components/app_components/WarehousePage/SingleWarehousePage";
import WarehouseProjectLayoutPage from "../components/app_components/WarehousePage/WarehouseProjectLayoutPage";
//  ~cb-add-import~
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/warehouse/:singleWarehouseId" exact element={<SingleWarehousePage />} />
<Route path="/warehouse" exact element={<WarehouseProjectLayoutPage />} />
